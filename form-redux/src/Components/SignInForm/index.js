      ...
      <div className="lg:flex items-center space-x-16">
        <div className="w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg">
          ...
          <form onSubmit={handleSubmit} className="my-8 text-sm">
            ...
            <label className="text-gray-700 mr-4">Age: </label>
            ...
            <label className="text-gray-700 mr-4">Gender: </label>
            ...
            <div className="my-4 flex items-center justify-end space-x-4">
              <button className="relative inline-flex items-center justify-start inline-block px-5 py-3 overflow-hidden font-bold rounded-md group">
                <span className="w-32 h-32 rotate-45 translate-x-12 -translate-y-2 absolute left-0 top-0 bg-black opacity-[3%]"></span>
                <span className="absolute top-0 left-0 w-48 h-48 -mt-1 transition-all duration-500 ease-in-out rotate-45 -translate-x-56 -translate-y-24 bg-[#2563EB] opacity-100 group-hover:-translate-x-8"></span>
                <span className="relative w-full text-left text-gray-600 transition-colors duration-200 ease-in-out group-hover:text-white">
                  Submit
                </span>
                <span class="absolute inset-0 border-2 border-stone-900 rounded-md hover:border-[1.5px]"></span>
              </button>
            </div>
          </form>
        </div>
        ...
        <div className="flex items-center justify-center">
          <svg
            className="text-blue-600 w-5/6  scale-x-[-1]"
